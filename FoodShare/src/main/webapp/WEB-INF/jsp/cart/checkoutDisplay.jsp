          ...
          <p>Orders are delivered on business days (Monday-Friday) excluding public holidays.</p>
			...
			<div class="col-6">
				...
				<form method="post" action=""
					...
					<h4>Enter Donner Shipping Details</h4>
					...
					<div class="mb-3">
						<label for="formGroupExampleInput1" class="form-label">
							Donner First Name </label> <br/> <input type="text" class="form-control"
					...
					<div class="mb-3">
						<label for="formGroupExampleInput1" class="form-label">
              Donner Last Name </label> <br/> <input type="number" class="form-control"
